  ...
  <Container fluid className="container-fluid footer">
    <Container>
      <Row className="footer-content">
        ...
        <Col className="container-footer-menu">
          <div className="footer-title-menu">
            <h3>Menu</h3>
          </div>
          <div className="footer-navmenu">
            <ul className="footer-menu">
              <li><a href="#inicio" className="link">Início</a></li>
              <li><a href="#quem-somos" className="link">Quem Somos</a></li>
              <li><a href="#agro-ai" className="link">Agro AI</a></li>
            </ul>
            <ul className="footer-menu">
              <li><a href="#noticias" className="link">Notícias</a></li>
              {/* <li><a href="#mercado" className="link-menu">Mercado</a></li> */}
              <li><a href="#faq" className="link">Perguntas Frequentes</a></li>
              <li><a href="#contato" className="link">Contato</a></li>
            </ul>
          </div>
        </Col>
        <Col className="container-address">
          <div className="footer-title-address">
            <h3>Endereço</h3>
          </div>
          <a href="https://maps.app.goo.gl/vRbdS1RhCzukrrAn7">
            Av. Paulista, 1106 - 7º andar - Bela Vista, São Paulo - SP, 01311-000
          </a>
        </Col>
        <Col className="conteiner-social">
        ...
        <Col className="container-policy">
    ...
    <div className="developed">
      ...
      <p>
        Guilherme Alves Rodrigues Ferreira<br />
        Guilherme Rafael Schumann Carvalho<br />
        João Pedro Brehula Souza<br />
        Joao Pedro Diniz Fernandes de Oliveira<br />
        Mariana Secchi Sanches<br />
      </p>
    </div>
  </Container>
);
